...
from backend.api.v1.utils.projects import (
    create_project,
    delete_project,
...
router = APIRouter(
    prefix="/projects", tags=["Projects"], dependencies=[Depends(dependency=DatabaseConfig.get_database)]
)
...
async def create_project_endpoint(
    request: Request, project: Create, db: AsyncDatabase = Depends(dependency=DatabaseConfig.get_database)
) -> Project:
    """
