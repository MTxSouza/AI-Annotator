...
def setup_task_config(project_id: str, task: Task) -> dict:
    ...
    task_config_instance = task_config_instance.model_dump()
    task_config_instance["project_id"] = PyObjectId(oid=project_id)  # Ensure project_id is PyObjectId.

    return task_config_instance
